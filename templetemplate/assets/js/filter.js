jQuery(document).ready(function(){
	...
	jQuery('.place-bid').on('click',function(e){
		...
		var ptemple = jQuery(this).data('temple');
	...
	jQuery('.create-claim').on('click',function(e){
		...
		var selectedFacts = [];
		var element1 = document.getElementsByClassName('selected-temples');
		...
		var s = jQuery.ajax({
	        ...
	        s.done(function(response){
				...
				window.location.href = origin+"/"+ptemple;
	...
	jQuery(".post-temple").on('click', function(e){
		e.preventDefault();
		var temple_id = jQuery(this).data("id");
		console.log("clicked");
		var s = jQuery.ajax({
			url:my_ajax_object.ajaxurl,
			method:'POST',
	...
	jQuery('.place-response').on('click',function(e){
		...
		var user_id = jQuery(this).data('user');
		var id_temple = jQuery(this).data('temple');
...
jQuery(':radio[name="status"]').change(function() {
	...
	jQuery('.rating').on('click',function(e){
		...
		jQuery.ajax({
			url:my_ajax_object.ajaxurl,
			data:{
				'action':'temple_add_profile_rating',
	...
	jQuery('.post_request_button').on('click',function(e){
		...
		jQuery.ajax({
			url:my_ajax_object.ajaxurl,
			data:{
				'action':'temple_update_post_request',
				'user_id':user_id,
				'content':content
			},
			method:'POST',
	...
	jQuery('.approve_request_button').on('click',function(e){
		...
		jQuery.ajax({
			url:my_ajax_object.ajaxurl,
			data:{
				'action':'temple_approve_post_request',
				'user_id':user_id
			},
			method:'POST',
			success:function(result){
